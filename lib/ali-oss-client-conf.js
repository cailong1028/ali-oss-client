module.exports = {
    development: {
        region: 'oss-cn-hangzhou', //默认oss-cn-hangzhou
        internal: false, //配合region使用，true表示内网访问
        secure: false, //配合region使用，true表示使用https访问
        endpoint: 'http://oss-cn-beijing.aliyuncs.com', //例如http://oss-cn-hangzhou.aliyuncs.com，如果指定了endpoint，则region会被忽略，endpoint可以指定HTTPS，也可以是IP形式
